  ...
  const renderContent = () => {
    return (
      <form action="#">
        ...
        <div className="p-5 border bg-white dark:bg-neutral-300 border-neutral-200 dark:border-neutral-600 rounded-xl flex items-center justify-center mt-4">
          ...
          <div className="mt-10 md:mt-0 space-y-5 sm:space-y-6 md:sm:space-y-8">
            <div className="space-y-3">
              {plans.map((plan) => (
                ...
                border-neutral-200 dark:border-neutral-600 px-3 sm:px-5 py-4 cursor-pointer flex 
