...
const PageCollection: FC<PageCollectionProps> = ({ className = "" }) => {
  return (
    ...
    >
      <Helmet>
        <title>Collection || Rize2Day </title>
      </Helmet>
      ...
      <div className="w-full">
        ...
        <div className="relative container -mt-14 lg:-mt-20">
          <div className=" bg-white dark:bg-[#191818] dark:border dark:border-neutral-600 p-5 lg:p-8 rounded-3xl md:rounded-[40px] shadow-xl flex flex-col md:flex-row lg:items-center">
            <div className="flex flex-col sm:flex-row md:block sm:items-start sm:justify-between">
              ...
              <div className="mt-4 flex items-center sm:justify-center space-x-3">
                ...
                <div className="h-5 border-l border-neutral-200 dark:border-neutral-600"></div>
