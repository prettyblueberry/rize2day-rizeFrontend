...
export const followSlice = createSlice({
    ...
    reducers: {
        changeFollow: (
            state,
            action: PayloadAction<FollowState["follow"]>
        ) => {
            return {
                ...state,
        ...
        changeIsExists: (
            state,
            action: PayloadAction<FollowState["isExists"]>
        ) => {
            return {
                ...state,
...
export const selectFollowList = (state: RootState) => state.follow.followinglist;
export const selectFollowingList = (state: RootState) => state.follow.followinglist;
